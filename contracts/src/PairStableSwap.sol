...
contract PairStableSwap is ISwappaPairV1 {
  ...
  function swap(
    ...
    require(ERC20(input).approve(swapPoolAddr, inputAmount), "PairStableSwap: approve failed!");
    ...
    require(ERC20(output).transfer(to, outputAmount), "PairStableSwap: transfer failed!");
  }
